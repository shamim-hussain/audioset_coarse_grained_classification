from lib.training.training import TrainingBase, StopTrainingException
...
class SaveModel(TrainingBase):
    def get_default_config(self):
        ...
        config.update(
            ...
            save_model_condition       = HDict.L("c:c.save_model_monitor+'<=save_monitor_value'"),
    ...
    def save_model(self, name):
        ...
        save_file = os.path.join(self.config.saved_model_path, name+'.pt')
